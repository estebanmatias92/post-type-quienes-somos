...
if ( !class_exists( 'Quienes_Somos_Get_Templates' ) ) :

    /**
     * Quienes_Somos_Get_Templates
     *
     ...
     */
    class Quienes_Somos_Get_Templates extends Post_Type_Quienes_Somos
    {
        ...
        private function get_template_hierarchy( $template )
        {
            ...
            $template_post_type = $template_slug . '-' . ( $template == 'taxonomy' ? get_query_var( 'taxonomy' ) : self::$post_type ) . '.php';
            ...
            if ( $theme_file = locate_template( array( $template_post_type ) ) ) {
                ...
                $file = PTQS_PLUGIN_ROOT . 'views/templates/' . $template;
            }
